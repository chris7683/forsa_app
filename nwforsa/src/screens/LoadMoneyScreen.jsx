...
import BNPLLimitStatus from '../components/BNPLLimitStatus';
import EnterAmountSection from '../components/EnterAmountSection';
import InstallmentPlanSection from '../components/InstallmentPlanSection';
import ProceedTransferButton from '../components/ProceedTransferButton';
import LoadMoneyScreenStyles from '../styles/LoadMoneyScreenStyles';
...
const LoadMoneyScreen = ({ navigation }) => {
  ...
  if (profileLoading || plansLoading) {
    return (
      <SafeAreaView style={LoadMoneyScreenStyles.container}>
        <View style={LoadMoneyScreenStyles.loadingContainer}>
  ...
  if (profileError || plansError) {
    return (
      <SafeAreaView style={LoadMoneyScreenStyles.container}>
        <View style={LoadMoneyScreenStyles.errorContainer}>
          <Text style={LoadMoneyScreenStyles.errorText}>{profileError?.message || plansError?.message}</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={LoadMoneyScreenStyles.container}>
      ...
      <ScrollView style={LoadMoneyScreenStyles.scrollViewContent}>
